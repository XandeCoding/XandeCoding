...
* **High-Performance Ecosystems:** Actively experimenting with Zig for low-level projects (like inference engines) and Bun for fast web execution.
* **Advanced Observability:** Deepening knowledge in OpenTelemetry, VictoriaMetrics, and Jaeger for tracing and monitoring distributed systems.
* **Identity & Security:** Studying API protection and OAuth 2.0 delegation flows.
